...
export function ProductForm({
  ...
  const [primaryImagePreview, setPrimaryImagePreview] = useState<string>(
    initialData?.product_primary_image || ""
  );
          ...
          <div className="space-y-6">
            <div className="p-4 bg-muted/20 rounded-xl space-y-4">
              ...
              <div className="space-y-2">
                ...
                <div
                  className="relative h-48 w-full border-2 border-dashed border-border rounded-xl overflow-hidden group hover:border-primary/50 transition-colors flex items-center justify-center bg-secondary/30 cursor-pointer"
                  onClick={() =>
