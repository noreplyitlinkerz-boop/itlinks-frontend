...
/**
 * Mock categories for the tech store
 */
export const categories: Category[] = [
  ...
  },
  {
    ...
    name: "Components",
    slug: "components",
    description: "CPU, GPU, RAM, and other computer components",
...
/**
 * Mock products for the tech store
 */
export const products: Product[] = [
  // Laptops
  {
    ...
    description:
      'Ultra-light business laptop with 14" display, powered by Intel Core i7',
    price: 1899.99,
    categoryId: "cat-1",
  ...
  },
  {
    ...
    name: "ROG Strix G16",
    description:
      'High-performance gaming laptop with RTX 4070 and 16" QHD display',
    price: 2499.99,
    categoryId: "cat-1",
  ...
  },
  {
    ...
    name: 'MacBook Pro 16"',
    description:
      "Professional laptop with M3 Pro chip and stunning Liquid Retina XDR display",
    price: 3299.99,
    categoryId: "cat-1",
  ...
  },
  {
    id: "prod-4",
    name: "Dell XPS 15",
    description: "Premium laptop with OLED display and powerful performance",
    price: 2199.99,
    categoryId: "cat-1",
  ...
  // Components
  {
    ...
    description:
      "16-core, 32-thread processor for high-end desktop performance",
    price: 699.99,
    categoryId: "cat-2",
  ...
  },
  {
    ...
    description:
      "Flagship graphics card with 24GB GDDR6X for ultimate gaming and creation",
    price: 1999.99,
    categoryId: "cat-2",
  ...
  },
  {
    ...
    description: "High-speed DDR5 RAM kit (2x16GB) at 6000MHz",
    price: 149.99,
    categoryId: "cat-2",
  ...
  },
  {
    ...
    description:
      "24-core processor with industry-leading single-thread performance",
    price: 589.99,
    categoryId: "cat-2",
  ...
  },
  {
    ...
    description: "High-performance GPU with 24GB GDDR6 memory",
    price: 999.99,
    categoryId: "cat-2",
  ...
  // Storage
  {
    ...
    description:
      "PCIe 4.0 NVMe SSD with blazing-fast read speeds up to 7,450 MB/s",
    price: 199.99,
    categoryId: "cat-3",
  ...
  },
  {
    ...
    description: "Gaming SSD with heatsink and exceptional performance",
    price: 129.99,
    categoryId: "cat-3",
  ...
  },
  {
    ...
    description: "NAS HDD designed for 24/7 operation and reliability",
    price: 259.99,
    categoryId: "cat-3",
    image: "/products/hdd-1.jpg",
    stock: 22,
    specs: {
      Capacity: "8TB",
      Speed: "7200 RPM",
  ...
  // Peripherals
  {
    ...
    description: "Premium wireless mouse with ultra-precise scrolling",
    price: 99.99,
    categoryId: "cat-4",
  ...
  // Networking
  {
    ...
    description: "Wi-Fi 6 router with 8 high-gain antennas and next-gen speeds",
    price: 299.99,
    categoryId: "cat-5",
    image: "/products/router-1.jpg",
    stock: 20,
    specs: {
  ...
  },
  {
    ...
    description: "5G mobile hotspot with WiFi 6E support",
    price: 799.99,
    categoryId: "cat-5",
    image: "/products/hotspot-1.jpg",
    stock: 9,
    specs: {
      "5G": "mmWave + Sub-6",
      "Wi-Fi": "Wi-Fi 6E",
  ...
  },
  {
    ...
    description: "Gaming router with 2.5G port and mobile game mode",
    price: 249.99,
    categoryId: "cat-5",
    image: "/products/router-2.jpg",
    stock: 16,
    specs: {
      "Wi-Fi Standard": "Wi-Fi 6 (802.11ax)",
      Speed: "5700Mbps",
      Ports: "1x 2.5G WAN/LAN, 4x Gigabit LAN",
      "Gaming Features": "Mobile Game Mode",
      VPN: "Yes",
    },
    featured: false,
...
export const orders: Order[] = [
  ...
  },
  {
    ...
    items: [
      {
        productId: "prod-16",
        productName: 'LG UltraGear 27" 4K',
        quantity: 2,
        price: 699.99,
      },
    ],
  ...
  },
  {
    ...
    customerEmail: "amanda.t@example.com",
  ...
  },
  {
    ...
    items: [
      {
        productId: "prod-18",
        productName: "TP-Link AX6000 Router",
        quantity: 1,
        price: 299.99,
      },
    ],
